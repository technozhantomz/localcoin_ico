...
<section class="main" id="main">
        <div class="main__bg">
          <video preload="auto" autoplay loop muted tabindex="0">
            <source src="img/main_bg_3.mp4" type="video/mp4">
          </video>
          <video preload="auto" autoplay loop muted tabindex="0">
            <source src="img/main_bg_2.mp4" type="video/mp4">
          </video>
          <video preload="auto" autoplay loop muted tabindex="0">
            <source src="img/main_bg.mp4" type="video/mp4">
          </video>
        </div>
        <div class="container">
          <div class="main__tab-links tab-links">
            <ul>
              <li><a class="gradient-text active" href="#preSale">Pre-sale</a></li>
              <li><a class="gradient-text" href="#airDrop">AirDrop</a></li>
            </ul>
          </div>
                ...
                <div class="pre-sale__slider-wrap">
                  <div class="pre-sale__slider">
                    ...
                    <div class="pre-sale__slide"><a class="ps-circuit__item ps-circuit__item_02 item-hover" href="#">
                        ...
                        <h4>Decentralized <br>chat</h4>
                        <div class="item-desc">
                          <h4>Decentralized <br>chat</h4>
                          <p>Blockchain based fully encrypted decentralized personal and group chats.</p>
                        </div></a></div>
                    ...
                    <div class="pre-sale__slide"><a class="ps-circuit__item ps-circuit__item_05 item-hover" href="#">
                        ...
                        <h4>Untraceable<br>Transactions</h4>
                        <div class="item-desc">
                          <h4>Untraceable<br>Transactions</h4>
                          <p>Fully private accounts with no tracing. Your personal chain is encrypted and no-one can see your transactions.</p>
                        </div></a></div>
                    ...
                    <div class="pre-sale__slide"><a class="ps-circuit__item ps-circuit__item_08 item-hover" href="#">
                        ...
                        <h4>Decentralized<br>trading</h4>
                        <div class="item-desc">
                          <h4>Decentralized<br>trading</h4>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="air-drop__left-block">
                    ...
                    <p class="wow fadeInUp">In order to get you LLC, just <a href="https://wallet.localcoin.is" target="_blank">sign up here</a> and type your ACCOUNT NAME <a href="https://t.me/LocalCoinIS" target="_blank">here</a>. Your wallet will be credited with LLC via telegram Bot after the reservation is over.</p>
...
<!--           <div class="row">
          ...
          <div class="row">
            <div class="col-md-6 offset-md-6">
              <div class="trading__item trading__item_01 wow fadeInUp">
                ...
                <p>There is no trading fees apart from the network ridiculously low commission. All you pay is fixed network fees just to push your transactions into the blockchain.</p>
              </div>
              ...
              <div class="trading__item trading__item_03 wow fadeInUp">
                <h5>Stealth mode</h5>
                <p>Zero-knowledge super-secure transactions ('unknown' sent 'n' 'unknown' to 'unknown')". That means you can place blind transactions from your account to a secret account that cannot be viewed via any blockexplorer.</p>
              </div>
              <div class="trading__item trading__item_04 wow fadeInUp">
                <h5>Maximum security</h5>
                <p>We don't have access to your account, simply because it is only You who hold secret key to it. There no way centralised trading platforms can compete with decentralization, full encryption, total anonymity, cold storage, rigorous access management.</p>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="tokeninfo" id="tokeninfo">
        <div class="container">
          <h2 class="wow fadeInUp">Token info</h2>
          <div class="row">
            <div class="col-lg-10">
              <div class="tokeninfo__tab-links tab-links">
                <ul>
                  <li><a class="active" href="#shares"><span class="xs-hidden">Allocation of shares</span><span class="xs-visible">Shares</span></a></li>
                  <li><a href="#useOfFunds">Use of funds</a></li>
                </ul>
              </div>
              <div class="tokeninfo__tab active" id="shares">
                <div class="tokeninfo__chart">
                  <canvas id="sharesChart" width="380" height="380"></canvas>
              ...
              <div class="tokeninfo__tab" id="useOfFunds">
                <div class="tokeninfo__chart">
                  <canvas id="useOfFundsChart" width="400" height="400"></canvas>
                  <div class="chart-item-value"></div>
                </div>
      ...
      <section class="roadmap" id="roadmap">
        <div class="container">
          <h2 class="wow fadeInUp">Road map</h2>
      ...
      <section class="download" id="download">
        <div class="container">
          <h2>Download</h2>
          <div class="row">
            <div class="col-md-4"><a class="download__item wow flipInY" href="https://mega.nz/#!lRkXCYzD!qmPj_DPeBsneOkZ74bzJrvBUoUy5lJkKIuSfmrvmER0" target="_blank" data-wow-delay=".2s">
                <h4>Windows</h4>
            ...
            <div class="col-md-4"><a class="download__item wow flipInY" href="https://mega.nz/#!ZE03XCSQ!59Oxz5rTOSeRMiVsXuR_5OCnXGKXla4DAeT6jmq5ZM0" target="_blank" data-wow-delay=".4s">
                <h4>Mac OS</h4>
            ...
            <div class="col-md-4"><a class="download__item wow flipInY" href="https://mega.nz/#!cAs11aIY!mqL41WwoFen_n24JzehPv5CJuSKTf5zeAOBANq_pH-s" target="_blank" data-wow-delay=".6s">
                <h4>Linux (Debian)</h4>
